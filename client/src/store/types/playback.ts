...
/** Ties the recording's clock to the live run's; without it the playhead anchors
 *  to whenever Play was pressed. */
...
export type RecorderState = {
  ...
  frames: number;
  bytes: number;
  /** Not the encoder's durationMs: a max across three tracks, it jumps around. */
  elapsedMs: number;
  durationMs: number;
  id: string | null;
};
