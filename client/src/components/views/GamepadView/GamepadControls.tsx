...
export const GamepadControls: React.FC<GamepadControlsProps> = ({
  ...
  const handleStickMove =
    (xKey: keyof GamepadState, yKey: keyof GamepadState) =>
    (x: number, y: number) => {
      if (anyHardwareConnected) return;
  ...
  return (
    <div
      className={clsx(
        'space-y-3',
        anyHardwareConnected && 'pointer-events-none opacity-60',
      )}
    >
      {/* Header */}
      <div className="flex items-center justify-between">
        ...
        <button
          className="rounded-md bg-gray-100 px-2.5 py-1 text-xs font-medium transition-colors hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700"
        ...
        <div className="mb-4 flex justify-between gap-4">
          <div className="flex flex-1 flex-col gap-2">
            ...
            <GamepadSlider
              ...
              keyBinding={
                showKeyBindings
                  ? formatKeyName(keyboardMapping.left_trigger || '')
                  : ''
              }
          ...
          <div className="flex flex-1 flex-col gap-2">
            <GamepadButton
              ...
              keyBinding={
                showKeyBindings
                  ? formatKeyName(keyboardMapping.right_bumper || '')
                  : ''
              }
            ...
            <GamepadSlider
              ...
              keyBinding={
                showKeyBindings
                  ? formatKeyName(keyboardMapping.right_trigger || '')
                  : ''
              }
        ...
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex flex-col items-center gap-3">
            <GamepadStick
              ...
              upKey={
                showKeyBindings
                  ? formatKeyName(keyboardMapping.left_stick_up || '')
                  : ''
              }
              downKey={
                showKeyBindings
                  ? formatKeyName(keyboardMapping.left_stick_down || '')
                  : ''
              }
              leftKey={
                showKeyBindings
                  ? formatKeyName(keyboardMapping.left_stick_left || '')
                  : ''
              }
              rightKey={
                showKeyBindings
                  ? formatKeyName(keyboardMapping.left_stick_right || '')
                  : ''
              }
              upLabel="Up"
              downLabel="Down"
              ...
              buttonKeyBinding={
                showKeyBindings
                  ? formatKeyName(keyboardMapping.left_stick_button || '')
                  : ''
              }
              onStickButtonClick={createButtonToggleHandler(
                gamepadState,
                gamepadNum,
                'left_stick_button',
                updateGamepadState,
              ...
              onStickButtonRelease={createButtonReleaseHandler(
                'left_stick_button',
              )}
            ...
            <div className="mt-1 grid grid-cols-3 gap-1.5">
              ...
              <GamepadButton
                ...
                keyBinding={
                  showKeyBindings
                    ? formatKeyName(keyboardMapping.dpad_up || '')
                    : ''
                }
              ...
              <GamepadButton
                ...
                keyBinding={
                  showKeyBindings
                    ? formatKeyName(keyboardMapping.dpad_left || '')
                    : ''
                }
              ...
              <GamepadButton
                ...
                keyBinding={
                  showKeyBindings
                    ? formatKeyName(keyboardMapping.dpad_right || '')
                    : ''
                }
              ...
              <GamepadButton
                ...
                keyBinding={
                  showKeyBindings
                    ? formatKeyName(keyboardMapping.dpad_down || '')
                    : ''
                }
          ...
          <div className="flex flex-col items-center justify-center gap-1.5">
            <GamepadButton
              ...
              keyBinding={
                showKeyBindings ? formatKeyName(keyboardMapping.back || '') : ''
              }
            ...
            <GamepadButton
              ...
              keyBinding={
                showKeyBindings
                  ? formatKeyName(keyboardMapping.guide || '')
                  : ''
              }
            ...
            <GamepadButton
              ...
              keyBinding={
                showKeyBindings
                  ? formatKeyName(keyboardMapping.start || '')
                  : ''
              }
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <div className="grid grid-cols-3 gap-1.5">
              ...
              <GamepadButton
                ...
                keyBinding={
                  showKeyBindings ? formatKeyName(keyboardMapping.y || '') : ''
                }
              ...
              <GamepadButton
                ...
                keyBinding={
                  showKeyBindings ? formatKeyName(keyboardMapping.x || '') : ''
                }
              ...
              <GamepadButton
                ...
                keyBinding={
                  showKeyBindings ? formatKeyName(keyboardMapping.b || '') : ''
                }
              ...
              <GamepadButton
                ...
                keyBinding={
                  showKeyBindings ? formatKeyName(keyboardMapping.a || '') : ''
                }
            ...
            <GamepadStick
              ...
              upKey={
                showKeyBindings
                  ? formatKeyName(keyboardMapping.right_stick_up || '')
                  : ''
              }
              downKey={
                showKeyBindings
                  ? formatKeyName(keyboardMapping.right_stick_down || '')
                  : ''
              }
              leftKey={
                showKeyBindings
                  ? formatKeyName(keyboardMapping.right_stick_left || '')
                  : ''
              }
              rightKey={
                showKeyBindings
                  ? formatKeyName(keyboardMapping.right_stick_right || '')
                  : ''
              }
              upLabel="Up"
              downLabel="Down"
              ...
              buttonKeyBinding={
                showKeyBindings
                  ? formatKeyName(keyboardMapping.right_stick_button || '')
                  : ''
              }
              onStickButtonClick={createButtonToggleHandler(
                gamepadState,
              ...
              onStickButtonPress={createButtonPressHandler(
                'right_stick_button',
              )}
              onStickButtonRelease={createButtonReleaseHandler(
                'right_stick_button',
