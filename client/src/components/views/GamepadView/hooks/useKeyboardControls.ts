...
export const useKeyboardControls = ({
  ...
  useEffect(() => {
    updateGamepadStateRef.current = updateGamepadState;
  }, [updateGamepadState]);
  ...
  useEffect(() => {
    ...
    const updateAffectedControls = (keyCode: string) => {
      ...
      if (
        keyCode === mapping.left_stick_left ||
        keyCode === mapping.left_stick_right ||
        keyCode === mapping.left_stick_up ||
        keyCode === mapping.left_stick_down
      ) {
        let leftStickX = 0;
        let leftStickY = 0;
      ...
      if (
        keyCode === mapping.right_stick_left ||
        keyCode === mapping.right_stick_right ||
        keyCode === mapping.right_stick_up ||
        keyCode === mapping.right_stick_down
      ) {
        let rightStickX = 0;
        let rightStickY = 0;
